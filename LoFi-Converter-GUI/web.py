...
FFMPEG_PATH = os.getenv('FFMPEG_BINARY', '/usr/bin/ffmpeg')
FFPROBE_PATH = os.getenv('FFPROBE_BINARY', '/usr/bin/ffprobe')

# Configure yt-dlp to use the correct FFmpeg paths
yt_dlp.utils.set_ffmpeg_location(FFMPEG_PATH)
